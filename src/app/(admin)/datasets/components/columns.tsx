...
export const USER_FIELDS = [
  ...
  { key: "genre",           label: "Genre",          type: "select" as const, options: ["Male", "Female", "Autre"] },
  { key: "typeAbonnement",  label: "Abonnement",     type: "select" as const, options: ["Freemium", "Premium", "Premium+"] },
  { key: "dateDeNaissance", label: "Date naissance", type: "text"   as const },
];

export const NUTRITION_FIELDS = [
  { key: "nom",       label: "Aliment",       type: "text"   as const, required: true },
  { key: "categorie", label: "Catégorie",     type: "text"   as const },
  { key: "typeRepas", label: "Repas",         type: "select" as const, options: ["Breakfast", "Lunch", "Dinner", "Snack"] },
  { key: "calories",  label: "Calories",      type: "number" as const },
  { key: "proteines", label: "Protéines (g)", type: "number" as const },
  { key: "glucides",  label: "Glucides (g)",  type: "number" as const },
  { key: "lipides",   label: "Lipides (g)",   type: "number" as const },
];

export const EXERCISE_FIELDS = [
  { key: "nom",             label: "Nom",             type: "text"   as const, required: true },
  { key: "typeExercice",    label: "Catégorie",       type: "select" as const, options: ["strength", "stretching", "plyometrics", "strongman", "powerlifting", "cardio", "olympic weightlifting"] },
  { key: "difficulte",      label: "Niveau",          type: "select" as const, options: ["beginner", "intermediate", "expert"] },
  { key: "equipement",      label: "Équipement",      type: "text"   as const },
  { key: "musclePrincipal", label: "Muscle principal",type: "text"   as const },
];

export const DIET_FIELDS = [
  { key: "typeMaladie",               label: "Pathologie",     type: "text"   as const },
  { key: "gravite",                   label: "Sévérité",       type: "select" as const, options: ["Mild", "Moderate", "Severe"] },
  { key: "apportCaloriqueJournalier", label: "Calories/j",     type: "number" as const },
  { key: "recommandationRegime",      label: "Recommandation", type: "select" as const, options: ["Balanced", "Low_Carb", "Low_Sodium"] },
  { key: "adherenceRegime",           label: "Adhérence (%)",  type: "number" as const },
];
